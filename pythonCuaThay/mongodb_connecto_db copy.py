...
def ExportToCSVFile_CityDistrict(city,district,filename):
  ...
  if filename is "":
    filename="/content/drive/My Drive/12.Vietnam Stock Analysts - Quantum Equity Research/Real Estate/"+city+"_"+district+".csv"
...
def ExportToCSVFile_OneCity(city,filename):
  ...
  if filename is "":
    filename="/content/drive/My Drive/12.Vietnam Stock Analysts - Quantum Equity Research/01. Real Estate/"+city+"_"+".csv"
...
def ExportToCSVFile_City_All_District(city,filename):
  #Get district of the city
  tinhtp="/content/drive/My Drive/12.Vietnam Stock Analysts - Quantum Equity Research/01. Real Estate/tinh_tp_danso_matdo.csv" #(Đọc thông tin Tỉnh/TP/Quận)
  df_city = pd.read_csv(tinhtp)
