...
collection = db[nameColl_tinh]

#import mongoDB from json
...
#     mongo_dict = json.loads(df.drop_duplicates(subset=['coordinates']).to_json(orient='records', force_ascii=False))
